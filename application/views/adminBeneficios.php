		  	...
		  	<div class="w3-container w3-row w3-margin-top">
		  		...
		  		<?php
		  			foreach ($dataBeneficios as $key => $beneficios) {
		  				...
		  				$beneficio = $beneficios['_columns'];
		  				switch ($beneficio['ben_tipo']) {
		  					case 1:
		  						echo "<div class = 'w3-col l3 m3 s3'>";
						  		echo "<h2>Hospedaje</h2>";
						  		echo "<hr>";
						  		echo "<div class = 'w3-container w3-row w3-margin-top' >";
						  		echo "<div class = 'w3-col l8 m8 s8'>";		
						  		echo "<fieldset class = 'descripcionBeneficio'>".$beneficio['ben_descripcion']."</fieldset>"; 				
						  		echo "</div>";
						  		echo "</div>";
						  		echo "</div>";
		  					break;
